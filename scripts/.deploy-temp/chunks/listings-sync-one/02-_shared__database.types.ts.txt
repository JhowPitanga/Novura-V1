/**
 * Supabase Database types for Edge Functions.
 * Regenerate with: supabase gen types typescript --project-id <project-id> > supabase/functions/_shared/database.types.ts
 * Or copy from src/integrations/supabase/types.ts after regenerating the frontend types.
 */
export type Json =
  | string
  | number
