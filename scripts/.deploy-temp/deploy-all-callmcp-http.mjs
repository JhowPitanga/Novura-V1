#!/usr/bin/env node
/** Deploy all 10 listing functions via Supabase MCP HTTP using callmcp-args. */
import fs from 'fs';
...
fs.writeFileSync(
  path.join(__dirname, 'deploy-results-callmcp.json'),
  JSON.stringify(results, null, 2),
);
console.error('Wrote deploy-results-callmcp.json');
