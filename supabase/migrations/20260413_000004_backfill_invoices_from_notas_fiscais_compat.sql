-- Backfill compatibility patch for environments where legacy rows no longer match current FK constraints.
-- This migration is idempotent and keeps order_id NULL when legacy order references are orphaned.
