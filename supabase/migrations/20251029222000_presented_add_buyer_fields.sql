-- Adiciona colunas do comprador na view marketplace_orders_presented
-- id_buyer, first_name_buyer, last_name_buyer com fallbacks para evitar NULLs
...
SELECT
  ...
  -- Novas colunas do comprador com fallbacks para evitar NULL
  COALESCE(
    (b.buyer->>'id')::bigint,
  ...
  -- Colunas de pagamento já adicionadas
  COALESCE(
