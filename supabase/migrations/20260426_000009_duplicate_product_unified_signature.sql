-- ============================================================
-- Unify duplicate_product RPC signature
-- Keeps only: duplicate_product(p_product_id uuid, p_with_images boolean)
-- ============================================================
BEGIN;

DROP FUNCTION IF EXISTS public.duplicate_product(uuid);
...
BEGIN
  ...
  -- Optional duplicate of image metadata
