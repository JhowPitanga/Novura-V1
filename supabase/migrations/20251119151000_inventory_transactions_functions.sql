    ...
    IF v_product_id IS NOT NULL THEN
      ...
      IF FOUND THEN
        ...
        INSERT INTO public.inventory_transactions (
          ...
          v_org_id, v_company_id, v_product_id, p_storage_id, v_pack_id, 'RESERVA', (-1) * v_qty, now(), CONCAT('PEDIDO[', COALESCE(v_pack_id::text, '0'), ']')
        );
      END IF;
    END IF;
  END LOOP;
    ...
    IF v_product_id IS NOT NULL THEN
      ...
      IF FOUND THEN
        ...
        INSERT INTO public.inventory_transactions (
          ...
          v_org_id, v_company_id, v_product_id, p_storage_id, v_pack_id, 'SAIDA', (-1) * v_qty, now(), CONCAT('PEDIDO[', COALESCE(v_pack_id::text, '0'), ']')
        );
      END IF;
    END IF;
  END LOOP;
    ...
    IF v_product_id IS NOT NULL THEN
      ...
      IF FOUND THEN
        ...
        INSERT INTO public.inventory_transactions (
          ...
          v_org_id, v_company_id, v_product_id, p_storage_id, v_pack_id, 'CANCELAMENTO_RESERVA', v_qty, now(), CONCAT('PEDIDO[', COALESCE(v_pack_id::text, '0'), ']')
        );
      END IF;
    END IF;
  END LOOP;
