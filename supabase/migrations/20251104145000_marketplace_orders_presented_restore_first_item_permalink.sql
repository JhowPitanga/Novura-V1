-- Recria a view marketplace_orders_presented incluindo first_item_permalink
-- e mantendo shipment_substatus e indicadores de etiqueta em cache
...
SELECT
  ...
  -- Indicadores de etiqueta em cache
